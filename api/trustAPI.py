...
class trustAPI():
    ...
    def trust_regoster(self,session):
    ...
    def recharge(self, session, data, amount='1000',code="8888"):
        data={"paymentType":"chinapnrTrust","formStr":"reForm","amount":amount,"valicode":code}
